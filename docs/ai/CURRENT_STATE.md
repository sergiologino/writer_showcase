...
- **Память проекта**: `docs/ai/*`. Сверка с исходным ТЗ и план работ: [`TZ_BACKLOG.md`](../TZ_BACKLOG.md).
...
1. **Публикация в TG/VK (углубление)**: обновление поста в канале при редактировании, шифрование секретов каналов at rest, расширенный формат сообщений (медиа, превью ссылок); при нескольких инстансах API — блокировки строк лога (например `SKIP LOCKED`) или вынос воркера.
